  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved leader as @leader" do
        ...
        post :create, {:leader => { "person" => "invalid value" }}, valid_session
        assigns(:leader).should be_a_new(Leader)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested leader" do
        ...
        Leader.any_instance.should_receive(:update).with({ "person" => "" })
        put :update, {:id => leader.to_param, :leader => { "person" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the leader as @leader" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Leader.any_instance.stub(:save).and_return(false)
        put :update, {:id => leader.to_param, :leader => { "person" => "invalid value" }}, valid_session
        assigns(:leader).should eq(leader)
      end
