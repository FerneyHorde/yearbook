  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved day as @day" do
        ...
        post :create, {:day => { "name" => "invalid value" }}, valid_session
        assigns(:day).should be_a_new(Day)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested day" do
        ...
        Day.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => day.to_param, :day => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the day as @day" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Day.any_instance.stub(:save).and_return(false)
        put :update, {:id => day.to_param, :day => { "name" => "invalid value" }}, valid_session
        assigns(:day).should eq(day)
      end
